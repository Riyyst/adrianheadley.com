...
const siteSearchBaseIndex = [
  ...
  {title:"Privacy",type:"Page",description:"How the Adrian Headley portfolio handles privacy, contact form data and accessibility preferences.",path:"Pages/privacy.html",keywords:"privacy data cookies accessibility contact form tracking analytics ads"},
  {title:"Security & Trust",type:"Page",description:"Security, trust, data flows and vulnerability reporting for the Adrian Headley portfolio.",path:"Pages/security.html",keywords:"security trust vulnerability disclosure security.txt antivirus web filter zscaler"},
  {title:"Terms of Use",type:"Page",description:"Terms for using the Adrian Headley portfolio website and its content.",path:"Pages/terms.html",keywords:"terms use website portfolio content copyright external links"},
